...
class ApplicationUpdate(BaseModel):
    ...
    chat_message: Optional[str] = Field(default=None, max_length=5000)
    rejection_message: Optional[str] = Field(default=None, max_length=5000)
    interview_message: Optional[str] = Field(default=None, max_length=5000)
...
class ApplicationStateResponse(BaseModel):
    ...
    vacancy_status_id: Optional[int] = None
    vacancy_status_name: Optional[str] = None
    resume_is_active: Optional[bool] = None